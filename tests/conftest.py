...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/displayfx
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/displayfx

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/displayfx/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/displayfx/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/displayfx/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/displayfx
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/displayfx
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/displayfx/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/displayfx/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/displayfx
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/displayfx
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/displayfx
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/displayfx
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/displayfx
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/displayfx
...
.. image:: https://img.shields.io/pypi/status/displayfx
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/displayfx
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/displayfx
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/displayfx
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/displayfx
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/displayfx
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/displayfx
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/displayfx/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/displayfx
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/displayfx

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/displayfx/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/displayfx/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/displayfx/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/displayfx/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/displayfx
    :alt: PyPi
...
class EnvSetUp:
    ...
    def make_packageit_ini(self):
        ...
        ini['Detail'] = {
            ...
            f'{get_os()}ProjectAnchorDir': self.dir,
            f'{get_os()}ProjectIniDir': Path(self.dir, 'ini'),
            'PythonRequires': '>=3.6',
        ...
        ini['tool:pytest'] = {
            ...
            '--cov-report=html',
            'addopts_ide': '--ignore-glob=*/VersionArchive ' '--ignore-glob=*/Archive ' '--cov-report=html',
        }
        ini['VEnv'] = {
            'Enable': 'Yes',
            'Upgrade': 'Yes',
            'ReinstallVEnv': 'No',
            f'{get_os()}VEnvBaseFolder': self.dir,
            f'{get_os()}VEnvAnchorDir': self.dir / 'venv',
        }
